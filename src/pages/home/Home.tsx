...
const Index = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      if (journeyRef.current) {
        journeyObserver.unobserve(journeyRef.current);
      }
      if (wildRef.current) {
    ...
    <div className="min-h-screen bg-primary text-white">
      ...
      <section className="relative h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 animate-fade-up">
          ...
          <h1 className="font-heading text-6xl md:text-8xl mb-8">Dawnlight journey</h1>
          <a
            href="/destinations"
        ...
        <div className="absolute bottom-12 left-12 text-sm tracking-wider">
          19.2228° S, 22.7999° E
        </div>
      </section>
          ...
          <div className="space-y-8 animate-fade-up">
            ...
            <div className="space-y-6 text-gray-300">
              ...
              <p className="text-lg leading-relaxed">
                ...
                true Dawnlight journey. With access to over 6 million acres of private
                land, we offer intimate wildlife encounters and experiences that
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-lg leading-relaxed mb-12 max-w-3xl mx-auto">
              ...
              cultures are waiting to be revealed, and we at Dawnlight journey can't
              wait to share them with you. Our custom-designed journeys are
              intended to inspire but can be tailor-made to suit your every
