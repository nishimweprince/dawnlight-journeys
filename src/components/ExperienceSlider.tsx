...
const experiences = [
  ...
  },
  {
    ...
    description:
      'Capture extraordinary moments in the wild, from big cats on the hunt to birds in flight, guided by expert wildlife photographers.',
  ...
  },
  {
    ...
    description:
      'Drift silently above vast plains and watch wildlife from a unique perspective as the golden morning light bathes the landscape.',
  ...
  },
  {
    ...
    description:
      'Connect with local communities, learn about ancient traditions, and participate in authentic cultural experiences and ceremonies.',
  ...
  },
  {
    ...
    description:
      'Paddle through tranquil waterways, coming face-to-face with hippos, elephants and other wildlife in their natural habitat.',
...
const purposeCategories = [
  {
    ...
    title: 'DESTINATIONS',
    description:
      'Our accommodation is both luxurious and authentic. We promise unrivalled comfort and exclusivity while staying true to the vibrant soul and spirit of each, unique destination.',
  ...
  },
  {
    ...
    title: 'WILDLIFE',
    description:
      'Our camps and lodges are located in prime wildlife areas, offering exceptional game viewing opportunities. From the Big Five in Southern Africa to the Great Migration in East Africa.',
  ...
  },
  {
    ...
    title: 'GUIDES',
    description:
      'Our expert guides have unrivaled knowledge of the Dawnlight journey areas where we operate, ensuring you have the most enriching and educational safari experience possible.',
  ...
  },
  {
    ...
    title: 'ARCHITECTURE',
    description:
      'Each of our camps and lodges is designed to blend seamlessly with its natural surroundings, using sustainable materials and practices to minimize environmental impact.',
  ...
  },
  {
    ...
    title: 'CULTURE',
    description:
      'Immerse yourself in local cultures and traditions, learning from communities that have lived in harmony with nature for generations. Our cultural experiences provide authentic insights.',
  ...
  },
  {
    ...
    title: 'TRAVEL',
    description:
      'Our seamless travel arrangements ensure you enjoy a stress-free safari experience from start to finish, with private transfers, charter flights, and personalized itineraries.',
  ...
  },
  {
    ...
    title: 'IMPACT',
    description:
      "By choosing Dawnlight journey, you're directly contributing to conservation efforts and community development projects across Africa, leaving a positive footprint on the places you visit.",
...
<<<<<<< Updated upstream
  const activeCategory =
    purposeCategories.find((cat) => cat.id === activeCategoryId) ||
    purposeCategories[0];

  return (
    <>
      <section className="relative bg-black text-white py-12 overflow-hidden">
        <article className="max-w-[1200px] mx-auto mb-12 px-8">
          <p className="text-[#FF5C28]/90 uppercase tracking-widest text-sm mb-3">
            OUR EXPERIENCES
          </p>

          <header className="flex flex-col md:flex-row justify-between items-start">
            <article className="md:w-[55%]">
=======
  return (
    <>
      <section className="relative bg-black text-white py-12 overflow-hidden">
...
<<<<<<< Updated upstream
                Travelling is about more than the places you visit and the
                things you'll see. It's about people, culture, wildlife,
                history, and experiencing something you've never done before.
                With Dawnlight journey you'll walk, boat, barge, float, fly,
...
<<<<<<< Updated upstream
            <article className="relative">
              <article className="flex flex-col lg:flex-row items-center">
                <figure className="relative w-[500px] h-[500px] z-20">
                  <article className="w-[500px] h-[500px] overflow-hidden rounded-full border-8 border-black">
                    <img
                ...
                <article className="relative w-[500px] ml-[-100px] z-10">
                  <article className="bg-[#0A3531] p-10 min-h-[450px] flex flex-col justify-between">
                    <article className="mt-8 ml-16">
                      ...
                      <Link
                        to={`/experiences/${experiences[currentSlide].title
                          .toLowerCase()
                          .replace(/\s+/g, '-')}`}
                        className="inline-flex items-center text-[#FF5C28] hover:text-[#FF7040] group"
                      >
                        <article className="w-8 h-8 rounded-full border border-[#FF5C28] flex items-center justify-center mr-3 group-hover:bg-[#FF5C28] group-hover:text-white transition-all">
                          <ArrowRight size={16} />
                        </article>
                    ...
                    <address className="mt-auto pt-6 ml-16 flex items-center space-x-2 text-white/80 not-italic">
                      <MapPin size={16} />
                      <p className="text-xs">
          ...
          <nav className="flex justify-between items-center mt-8 px-8 w-[65%] mx-auto">
...
<<<<<<< Updated upstream
      <section className="bg-[#221F26] text-white py-16">
        <article className="container mx-auto px-8">
          ...
          <article className="grid grid-cols-1 md:grid-cols-2 gap-20 mb-16">
            <article>
              <h2 className="font-heading text-5xl md:text-6xl mb-6">
                Why travel with Dawnlight journey?
              </h2>
            ...
            <article>
              <p className="text-white/80 text-base md:text-lg leading-relaxed">
                ...
                vibrant soul and spirit of each, unique destination. Our private
                game viewing areas have limits on guest numbers, meaning fewer
                vehicles and people, with more intimate and up-close encounters
                with wildlife in their natural habitat.
              </p>
            </article>
          </article>

          <nav className="mb-0 border-b-0 pb-0">
            <article className="flex flex-wrap justify-center space-x-6 mb-0">
                ...
                <article key={category.id} className="relative">
                  ...
                  >
                    ...
                    <article
                      ...
                      style={{
                        transformOrigin:
                          category.id === activeCategoryId ? 'left' : 'right',
                      }}
                    />
                  </button>
                </article>
          ...
          <article className="mt-16 flex justify-center relative">
            <article className="w-full max-w-5xl">
              <article className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                <figure className="h-[400px] overflow-hidden rounded-sm mx-auto w-full">
                  <img
                    src={activeCategory.image}
                    alt={activeCategory.heading}
                    className="w-full h-full object-cover transition-all duration-500 animate-[fadeIn_0.5s_ease]"
                ...
                <article className="flex flex-col justify-center mx-auto text-center md:text-left">
                  <h3 className="font-heading text-4xl md:text-5xl mb-6 animate-[fadeUp_0.4s_ease]">
                    {activeCategory.heading}
                  </h3>
                  <p className="text-white/80 text-base mb-6 animate-[fadeUp_0.5s_ease]">
            ...
            <nav className="absolute top-1/2 left-0 -translate-y-1/2 w-full flex justify-between items-center px-4">
              <button
                className="p-2 text-[#FF5C28] hover:text-white transition-colors bg-[#221F26]/80 rounded-full"
                onClick={() =>
                  setActiveCategoryId((prev) =>
                    prev === 1 ? purposeCategories.length : prev - 1
                  )
                }
                aria-label="Previous category"
              >
              ...
              <button
                ...
                onClick={() =>
                  setActiveCategoryId((prev) =>
                    prev === purposeCategories.length ? 1 : prev + 1
                  )
                }
                aria-label="Next category"
              >
