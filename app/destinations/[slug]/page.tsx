    ...
    faqs: [
      {
        ...
        answer:
          'June to September and December to February are the best months for wildlife viewing, with less rainfall and comfortable temperatures.',
      },
      {
        question: 'Is Rwanda safe for tourists?',
        answer:
          'Yes, Rwanda is considered one of the safest countries in Africa for tourists. The country has made remarkable progress in terms of security and infrastructure.',
      },
      {
        question: 'Do I need a visa to visit Rwanda?',
        answer:
          'Citizens of many countries can obtain a visa on arrival or apply online through the Rwanda Immigration website. It is recommended to check the latest requirements before traveling.',
      },
      {
        question: 'What should I pack for gorilla trekking?',
        answer:
          'For gorilla trekking, pack lightweight, long-sleeved clothing, sturdy hiking boots, rain gear, gardening gloves for gripping vegetation, insect repellent, and a hat. Neutral colors (green, khaki, brown) are recommended.',
      },
    ],
    ...
    faqs: [
      {
        ...
        answer:
          'Uganda is famous for its mountain gorillas, diverse wildlife, beautiful lakes, and being home to the source of the Nile River. It also has a rich cultural heritage with over 50 ethnic groups.',
      },
      {
        question: 'Do I need a visa to visit Uganda?',
        answer:
          'Most visitors need a visa, which can be obtained online through the official e-visa portal or on arrival at Entebbe International Airport.',
      },
      {
        question: 'What vaccinations do I need for Uganda?',
        answer:
          'Yellow fever vaccination is mandatory for all visitors. Other recommended vaccinations include hepatitis A and B, typhoid, meningitis, and routine vaccinations. Malaria prevention is also strongly advised.',
      },
      {
        question: 'What is the best time to visit Uganda?',
        answer:
          'The dry seasons (December to February and June to August) are generally the best times to visit for wildlife viewing and gorilla trekking, as trails are less muddy and animals gather around water sources.',
      },
    ],
    location: 'East Africa',
...
export default function DestinationDetailsPage({
  ...
  return (
    <main className="min-h-screen flex flex-col bg-gradient-to-b from-orange-50 to-white">
            ...
            <section className="mb-12 grid md:grid-cols-2 gap-8">
              <article className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <p className="text-gray-600">
                  {destination.travelStyle.description}
                </p>
              </article>
              ...
              <article className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <p className="text-gray-600">
                  {destination.physicalRating.description}
                </p>
              </article>
              ...
              <article className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <p className="text-gray-600">
                  {destination.serviceLevel.description}
                </p>
              </article>
              ...
              <article className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <p className="text-gray-600">
                  {destination.tripType.description}
                </p>
              </article>
            </section>
            ...
            <section className="mb-12">
              <h3 className="text-2xl font-bold mb-6 text-gray-900 flex items-center gap-2">
                ...
                <span className="text-sm font-normal text-gray-500">
                  ({destination.faqs.length} questions)
                </span>
              </h3>
            ...
            <article className="bg-white rounded-2xl shadow-lg sticky top-8 overflow-hidden">
              ...
              <section className="p-6">
                ...
                <ul className="space-y-3 mb-6">
                  ...
                  <li className="flex items-center gap-2 text-sm text-gray-700">
                    <Users className="h-4 w-4 text-primary" /> Small group, max
                    12 people
                  </li>
                  <li className="flex items-center gap-2 text-sm text-gray-700">
      ...
      <section className="bg-primary/5 py-16">
        <section className="container mx-auto px-4 md:px-8 text-center">
          ...
          <p className="text-gray-700 mb-8 max-w-2xl mx-auto">
            Discover our other exciting destinations across Africa and create
      ...
      <section className="flex justify-start w-[90%] mx-auto my-6">
        <CustomButton href="/destinations">Back</CustomButton>
      </section>
    </main>
  );
}
